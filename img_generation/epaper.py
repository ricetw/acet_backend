...
from .aes256_data import gen_aes_data
...
class GenerateEPaperImage():
    ...
    def gen_image(self, data: Dict):
        ...
        cv2.imwrite("./img_generation/photo_temp/photo.png", image)
        return self
    ...
    def gan_qrcode(self, encrypt_aes_data):  # QR資料
        ...
        qr_img.save(f"./img_generation/photo_temp/AES_QRcode.png")

    # QRcode添加
    def add_qrcode(self, qr_data):
        encrypt_aes_data = gen_aes_data(qr_data)

        self.gan_qrcode(encrypt_aes_data)  # 生成加密的QRcode
        qr_image = cv2.imread("./img_generation/photo_temp/AES_QRcode.png")
        e_paper_image = cv2.imread("./img_generation/photo_temp/photo.png")
        ...
        cv2.imwrite("./img_generation/photo_temp/result_image.png", e_paper_image)
        self.result_image = cv2.imread("./img_generation/photo_temp/result_image.png")
